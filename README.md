# Globetrotter Web Project Installation Guide

This guide will walk you through the installation process for the Globetrotter web project. Follow the steps below to set up the project locally on your machine.
...
1. Clone the Globetrotter repository from GitHub:

   ```
   git clone https://github.com/Het-Vegad/Globetrotter.git
   ```
